...
const ValuesSection: React.FC<ValuesSectionProps> = ({ title }) => {
  ...
  return (
    <Container>
      <div className="flex flex-col items-center justify-center gap-6 md:gap-12 px-2 md:px-8">
        <div className="text-center">
          <h2 className="text-2xl md:text-[28px] font-semibold text-white uppercase">{title || t("about.values.title")}</h2>
        </div>
